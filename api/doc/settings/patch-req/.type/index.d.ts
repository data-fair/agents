...
export declare function validate(data: any): data is PatchSettingsReq
export declare function assertValid(data: any, options?: import('@data-fair/lib-validation').AssertValidOptions): asserts data is PatchSettingsReq
export declare function returnValid(data: any, options?: import('@data-fair/lib-validation').AssertValidOptions): PatchSettingsReq
