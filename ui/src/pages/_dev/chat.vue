...
const mockMessages: ChatMessage[] = [
  ...
  {
    role: 'assistant',
    content: '# Titre niveau 1\n\nParagraphe sous le titre de niveau 1 pour juger de la densité du texte courant.\n\n## Titre niveau 2\n\nParagraphe sous le titre de niveau 2.\n\n### Titre niveau 3\n\nParagraphe sous le titre de niveau 3.\n\n#### Titre niveau 4\n\nParagraphe sous le titre de niveau 4.\n\n##### Titre niveau 5\n\nParagraphe sous le titre de niveau 5.\n\n###### Titre niveau 6\n\nParagraphe sous le titre de niveau 6.'
  }
]
</script>
