...
export default {
  ...
  privateDataFairUrl: process.env.DF_PORT ? `http://localhost:${process.env.DF_PORT}` : 'http://data-fair:8080',
  privateEventsUrl: process.env.EVENTS_PORT ? `http://localhost:${process.env.EVENTS_PORT}` : undefined,
  mongoUrl: process.env.MONGO_PORT ? `mongodb://localhost:${process.env.MONGO_PORT}/data-fair-agents-test` : 'mongodb://localhost:27017/data-fair-agents-test',
  tmpDir: './tmp',
  observer: {
    active: false,
