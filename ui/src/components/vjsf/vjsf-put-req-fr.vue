...
const compiledLayout = {
  ...
  normalizedLayouts: {
    ...
    "https://github.com/data-fair/agents/settings-put#/properties/models/properties/assistant": {
      ...
      title: "Assistant",
      subtitle: "<p>Modèle conversationnel principal. Modèles suggérés : claude-3-5-haiku, gpt-4o-mini, gemini-2.0-flash, mistral-small-latest, minimax-01.</p>",
      defaultData: {},
    ...
    "https://github.com/data-fair/agents/settings-put#/properties/models/properties/assistant/properties/roles": {
      ...
      help: "<p>Rôles autorisés à utiliser ce modèle via la passerelle (vide = admin uniquement)</p>",
      defaultData: [],
    ...
    "https://github.com/data-fair/agents/settings-put#/properties/models/properties/summarizer": {
      ...
      title: "Résumeur",
      subtitle: "<p>Modèle utilisé pour la synthèse de l&#39;historique (optionnel, par défaut l&#39;assistant). Modèles suggérés : claude-3-5-haiku, gpt-4o-mini, gemini-2.0-flash-lite, mistral-small-latest.</p>"
    },
    ...
    "https://github.com/data-fair/agents/settings-put#/properties/models/properties/evaluator": {
      ...
      title: "Évaluateur",
      subtitle: "<p>Modèle utilisé pour les tâches d&#39;évaluation (optionnel, par défaut l&#39;assistant). Modèles suggérés : claude-3-5-haiku, gpt-4o-mini, gemini-2.0-flash, mistral-small-latest.</p>"
    },
  ...
  validationErrors: {},
  expressions: [expression0, expression1, expression2, expression3, expression4, expression5, expression6, expression7, expression8, expression9, expression10, expression11, expression12, expression13, expression14, expression15, expression16],
  locale: "fr",
